...
public class ThreePhasePanel extends JPanel implements MouseListener, MouseMotionListener {
	...
	public void mousePressed(MouseEvent e) {
		if(getStartLineOW() < e.getX() && e.getX()<getStartLineOW() + 15) {
			isStartOWSelected = true;
		}
		else if(getEndLineOW() < e.getX() && e.getX() < getEndLineOW()+15) {
			isEndOWSelected = true;
		}
		else if(getEndLineOG() < e.getX() && e.getX() < getEndLineOG()+15) {
			isEndOGSelected = true;
		}
		else if(getStartLineOG() < e.getX() && e.getX() < getStartLineOG()+15) {
